...
Clone this repository onto the NUC, which can be accessed via ssh. You should be able to do `ssh control@duckmaster.local` from the BYU Robotics Wifi. The IP address should be 192.168.X.136 
